...
name=input("Hai, What's your name??")
age=int(input("How old are you??"))
weight=int(input("Okay,last question. How many kilo do you weigh??"))
...
print("\nDid you know that on the moon you would weigh only ",moon_weight," kilo grams?")
